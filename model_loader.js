...
//             // Traverse through the loaded model to find meshes and compute bounding boxes
//             object.traverse((child) => {
//                 if (child.isMesh) {
//                     child.castShadow = true;
//                     child.receiveShadow = true;

//                     // Check for geometry existence
//                     if (child.geometry) {
//                         if (!child.geometry.boundingBox) {
//                             child.geometry.computeBoundingBox(); // Generate bounding box if missing
//                         }
//                         child.boundingBox = child.geometry.boundingBox; // Attach bounding box to mesh
//                     } else {
//                         console.warn(`Mesh ${child.name} does not have geometry.`);
//                     }
//                 }
//             });
